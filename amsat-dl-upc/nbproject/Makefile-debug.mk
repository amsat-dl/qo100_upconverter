...
SOURCEFILES_QUOTED_IF_SPACED=src/driver/adf4351.c src/driver/usart.c src/driver/irq.c src/driver/kty82.c src/driver/adc.c src/main.c src/pinmap.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/driver/adf4351.p1 ${OBJECTDIR}/src/driver/usart.p1 ${OBJECTDIR}/src/driver/irq.p1 ${OBJECTDIR}/src/driver/kty82.p1 ${OBJECTDIR}/src/driver/adc.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/pinmap.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/driver/adf4351.p1.d ${OBJECTDIR}/src/driver/usart.p1.d ${OBJECTDIR}/src/driver/irq.p1.d ${OBJECTDIR}/src/driver/kty82.p1.d ${OBJECTDIR}/src/driver/adc.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/pinmap.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/driver/adf4351.p1 ${OBJECTDIR}/src/driver/usart.p1 ${OBJECTDIR}/src/driver/irq.p1 ${OBJECTDIR}/src/driver/kty82.p1 ${OBJECTDIR}/src/driver/adc.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/pinmap.p1

# Source Files
SOURCEFILES=src/driver/adf4351.c src/driver/usart.c src/driver/irq.c src/driver/kty82.c src/driver/adc.c src/main.c src/pinmap.c
...
Device=PIC18F2520
ProjectDir=/Daten1/Daten/funk/sat/Amsat-Boards/V3_4/upconverter/amsat-dl-upc
ProjectName=amsat-dl-sdc
ConfName=debug
ImagePath=dist/debug/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
ImageDir=dist/debug/${IMAGE_TYPE}
ImageName=amsat-dl-upc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-debug.mk dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_debug=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"src" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -mrom=default,-7dc0-7fff -mram=default,-5f4-5ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.map  -DXPRJ_debug=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"src" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/amsat-dl-upc.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
endif

.pre:
	@echo "--------------------------------------"
	@echo "User defined pre-build step: [./versioneer hg.h]"
	@./versioneer hg.h
	@echo "--------------------------------------"
